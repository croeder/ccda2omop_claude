...
var (
	...
	MedicationRule = MappingRule{
		...
		Fields: []FieldMapping{
			...
			{Source: "EffectiveTime.Low|EffectiveTime.Value", Target: "drug_exposure_start_date", Transform: "date", Optional: true},
			{Source: "EffectiveTime.Low|EffectiveTime.Value", Target: "drug_exposure_start_datetime", Transform: "time_ptr", Optional: true},
			{Source: "EffectiveTime.High|EffectiveTime.Low|EffectiveTime.Value", Target: "drug_exposure_end_date", Transform: "date", Optional: true},
			{Source: "EffectiveTime.High|EffectiveTime.Low|EffectiveTime.Value", Target: "drug_exposure_end_datetime", Transform: "time_ptr", Optional: true},
	...
	ImmunizationRule = MappingRule{
		...
		Fields: []FieldMapping{
			{Source: "Code.Code", Target: "drug_concept_id", Transform: "vocab", VocabField: "Code.CodeSystem"},
			{Source: "EffectiveTime", Target: "drug_exposure_start_date", Transform: "date", Optional: true},
			{Source: "EffectiveTime", Target: "drug_exposure_start_datetime", Transform: "time_ptr", Optional: true},
			{Source: "EffectiveTime", Target: "drug_exposure_end_date", Transform: "date", Optional: true},
			{Source: "EffectiveTime", Target: "drug_exposure_end_datetime", Transform: "time_ptr", Optional: true},
			{Source: "Code", Target: "drug_source_value", Transform: "format_source"},
	...
	ProcedureRule = MappingRule{
		...
		Fields: []FieldMapping{
			...
			{Source: "EffectiveTime.Low|EffectiveTime.Value", Target: "procedure_date", Transform: "date", Optional: true},
			{Source: "EffectiveTime.Low|EffectiveTime.Value", Target: "procedure_datetime", Transform: "time_ptr", Optional: true},
	...
	VitalSignRule = MappingRule{
		...
		Fields: []FieldMapping{
			...
			{Source: "EffectiveTime", Target: "measurement_date", Transform: "date", Optional: true},
			{Source: "EffectiveTime", Target: "measurement_datetime", Transform: "time_ptr", Optional: true},
	...
	DeviceRule = MappingRule{
		...
		Fields: []FieldMapping{
			...
			{Source: "EffectiveTime.Low|EffectiveTime.Value", Target: "device_exposure_start_date", Transform: "date", Optional: true},
			{Source: "EffectiveTime.Low|EffectiveTime.Value", Target: "device_exposure_start_datetime", Transform: "time_ptr", Optional: true},
